...
This sample demonstrates how to use the output of Layout model and some business rules to identify cross-page tables and merge them into one table by markdown format.
